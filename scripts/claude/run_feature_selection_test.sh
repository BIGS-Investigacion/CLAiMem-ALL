...
# Run feature space consistency analysis WITH feature selection on TEST dataset
...
OUTPUT="results/feature_space_analysis_selected_test"
...
echo "WITH FEATURE SELECTION (TEST DATASET)"

...
case "$6" in
    1)
        ...
        RESULTS_DIR=.results/$DATABASE_TRAIN/$2/$MIL_TECHNIQUE/ho-$PATIENT_STRAT-$DATABASE_TRAIN-$CURRENT_TRAIN-$DATABASE_TEST-$CURRENT_TEST/$MODEL_NAME
        ;;
    2)

...
$PWD/scripts/evaluator.sh tcga pam50 /media/jorge/SP_PHD_U3/perfil_molecular/features 10
$PWD/scripts/evaluator.sh tcga erbb2 /media/jorge/SP_PHD_U3/perfil_molecular/features 10
$PWD/scripts/evaluator.sh tcga er /media/jorge/SP_PHD_U3/perfil_molecular/features 10
$PWD/scripts/evaluator.sh tcga pr /media/jorge/SP_PHD_U3/perfil_molecular/features 10

$PWD/scripts/evaluator.sh tcga ihc /media/jorge/SP_PHD_U3/perfil_molecular/features 0
$PWD/scripts/evaluator.sh tcga ihc_simple /media/jorge/SP_PHD_U3/perfil_molecular/features 0

...
EXCLUDE_CLASSES = ['HER2-positive', 'PR-positive', 'ER-positive']  # Change to exclude specific classes from regression
...
data = {
    ...
    'NPG': [0.000, 0.000, -0.750, 0.056, 0.000, 0.020, -0.430, -0.457, 0.438, 0.000, 0.000],

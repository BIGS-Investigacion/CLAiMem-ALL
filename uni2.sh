...
CUDA_VISIBLE_DEVICES=$CUDA_DEV  python src/eval.py --k $K --models_exp_code $MODELS_EXP_CODE --save_exp_code $EXP_CODE_SAVE --task $TASK --model_type $CLAM_MODEL_TYPE --results_dir $RESULT_DIRECTORY --data_root_dir $DATA_ROOT_DIR --embed_dim $EMBED_DIM
